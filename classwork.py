...
def problem3():
    goodBad = ['GOOD_DATA',
     ...
     'GOOD_DATA']
    print(len(goodBad))
    goodBad.pop(2) # !! : you should be able to do this WITHOUT knowing the index position
    goodBad.pop(4) # !! : you should be able to do this WITHOUT knowing the index position
    goodBad.pop(6) # !! : you should be able to do this WITHOUT knowing the index position
    print(len(goodBad))
problem3()
...
for x in score_list:
    add = x + add
print(f"The SUM of the numbers is 140 {add}") # !! : use the sum() function 
